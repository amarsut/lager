...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- ÄNDRAD: createInventoryRow för att ta bort "Kopiera namn" och slå ihop kolumner ---
    function createInventoryRow(item, isOutOfStock) {
        ...
        // const safeName = escapeHTML(item.name).replace(/'/g, "\\'"); // Behövs inte längre för knappen
