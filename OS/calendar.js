...
window.CalendarView = ({ allJobs = [], setEditingJob, setView }) => {
    ...
    return (
        <div className="flex flex-col min-h-[calc(100vh-80px)] md:min-h-screen bg-transparent text-zinc-900 dark:text-white pb-0 transition-colors duration-500 relative max-w-[1400px] ml-0 w-full animate-in fade-in slide-in-from-left-4" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
            ...
            <div className="px-4 pt-4 lg:px-0 lg:pt-0 flex flex-col h-full">
                ...
                {/* HEADER */}
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-4 pb-4 border-b border-zinc-200/50 dark:border-white/5 lg:border-none lg:pb-0 gap-4">
